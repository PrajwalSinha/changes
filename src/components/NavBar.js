    ...
    <div className="row">
      <div className="col-12">
        <div style={{ background: "linear-gradient(to bottom, #003300 0%, #000000 100%)" }}>
          <div className="top-bar fixed-top" style={{ position: "sticky", top: "0px" }} >
            <div className="container-fluid">
              <div className="row align-items-center">
                <div className="col-12 col-lg-12 align-items-left">
                  <div className="display-4 fw-bold py-2 text-lg-start d-none d-lg-block ms-5" style={{ width: "100%", color: "white", fontFamily: "cursive" }}>
                    Minute Mentor
                  </div>
                </div>
                <nav className="navbar  ms-5 me-5 rounded-top" style={{ padding: "7.9999px", background: "rgba(0, 0, 0, 0.69)" }}>
                  <div className="nav" style={{ fontSize: "20px" }}>
